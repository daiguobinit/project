...
class MopSpider(object):
    def __init__(self):
        self.start_url = 'http://autoapi.dftoutiao.com/mopsearch_h5/searchnews?jsonpcallback=jQuery18302289075899111841_1547516058480&keywords={}&stkey_zixun=&lastcol_zixun={}&splitwordsarr=&stkey_video=&lastcol_video=&maintype=&domain=mopauto_pc&os=Win7&qid=&recgid=15417568671858769&_=1541999185686'
        # 获取数据接口的headers
        self.headers_one = {
            'Accept':'*/*',
    ...
    # 从借口中获取新闻列表信息
    def get_news_port_page(self, key_word, next_port_parameter):
        s = requests.session()
        s.keep_alive = False
