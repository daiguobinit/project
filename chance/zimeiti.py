...
break_flag = False
while page_num < 1000:
    url = 'https://api.auto.ifeng.com/cms/api/amop?page={}&pageCount=10'.format(str(page_num))
    page_num += 1
    ...
    try:
        ...
        for alist in data_list:
            ...
            date_time = createtime.split(" ")[0]
            get_time = time.mktime(time.strptime(date_time, "%Y-%m-%d"))
...
# filename = open('./../chance/zimeiti9yue.json', 'wb')
